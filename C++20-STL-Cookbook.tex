...
\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
	...
	\subsection*{\zihao{3} 6.4.\hspace{0.2cm}std::sort——排序容器元素}
	\addcontentsline{toc}{subsection}{6.4.\hspace{0.2cm}std::sort——排序容器元素}
	\subfile{content/chapter6/4.tex}
	
	\subsection*{\zihao{3} 6.5.\hspace{0.2cm}std::transform——修改容器内容}
	\addcontentsline{toc}{subsection}{6.5.\hspace{0.2cm}std::transform——修改容器内容}
	\subfile{content/chapter6/5.tex}
	
	\subsection*{\zihao{3} 6.6.\hspace{0.2cm}查找特定项}
	\addcontentsline{toc}{subsection}{6.6.\hspace{0.2cm}查找特定项}
	\subfile{content/chapter6/6.tex}
	
	\subsection*{\zihao{3} 6.7.\hspace{0.2cm}将容器的元素值限制在std::clamp的范围内}
	\addcontentsline{toc}{subsection}{6.7.\hspace{0.2cm}将容器的元素值限制在std::clamp的范围内}
	\subfile{content/chapter6/7.tex}
	
	\subsection*{\zihao{3} 6.8.\hspace{0.2cm}std::sample——采集样本数据集}
	\addcontentsline{toc}{subsection}{6.8.\hspace{0.2cm}std::sample——采集样本数据集}
	\subfile{content/chapter6/8.tex}
	
	\subsection*{\zihao{3} 6.9.\hspace{0.2cm}生成有序数据序列}
	\addcontentsline{toc}{subsection}{6.9.\hspace{0.2cm}生成有序数据序列}
	\subfile{content/chapter6/9.tex}
	
	\subsection*{\zihao{3} 6.10.\hspace{0.2cm}合并已排序容器}
	\addcontentsline{toc}{subsection}{6.10.\hspace{0.2cm}合并已排序容器}
	...
	\subsection*{\zihao{3} 10.2.\hspace{0.2cm}为path类特化std::formatter}
	\addcontentsline{toc}{subsection}{10.2.\hspace{0.2cm}为path类特化std::formatter}
