...
\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
	...
	\subsection*{\zihao{3} 2.2.\hspace{0.2cm}span类——使C语言数组更安全}
	\addcontentsline{toc}{subsection}{2.2.\hspace{0.2cm}span类——使C语言数组更安全}
	\subfile{content/chapter2/2.tex}
	
	\subsection*{\zihao{3} 2.3.\hspace{0.2cm}结构化绑定}
	\addcontentsline{toc}{subsection}{2.3.\hspace{0.2cm}结构化绑定}
	\subfile{content/chapter2/3.tex}
	
	\subsection*{\zihao{3} 2.4.\hspace{0.2cm}if和switch语句中初始化变量}
	\addcontentsline{toc}{subsection}{2.4.\hspace{0.2cm}if和switch语句中初始化变量}
	...
	\subsection*{\zihao{3} 3.6.\hspace{0.2cm}保持vector元素的顺序}
	\addcontentsline{toc}{subsection}{3.6.\hspace{0.2cm}保持vector元素的顺序}
	...
	\subsection*{\zihao{3} 4.1.\hspace{0.2cm}迭代器}
	\addcontentsline{toc}{subsection}{4.1.\hspace{0.2cm}迭代器}
	...
	\subsection*{\zihao{3} 4.3.\hspace{0.2cm}创建可迭代范围}
	\addcontentsline{toc}{subsection}{4.3.\hspace{0.2cm}创建可迭代范围}
	\subfile{content/chapter4/3.tex}
	
	\subsection*{\zihao{3} 4.4.\hspace{0.2cm}使迭代器与STL迭代器特性兼容}
	\addcontentsline{toc}{subsection}{4.4.\hspace{0.2cm}使迭代器与STL迭代器特性兼容}
	\subfile{content/chapter4/4.tex}
	
	\subsection*{\zihao{3} 4.5.\hspace{0.2cm}使用迭代器适配器填充STL容器}
	\addcontentsline{toc}{subsection}{4.5.\hspace{0.2cm}使用迭代器适配器填充STL容器}
	\subfile{content/chapter4/5.tex}
	
	\subsection*{\zihao{3} 4.6.\hspace{0.2cm}创建一个迭代器生成器}
	\addcontentsline{toc}{subsection}{4.6.\hspace{0.2cm}创建一个迭代器生成器}
	\subfile{content/chapter4/6.tex}
	
	\subsection*{\zihao{3} 4.7.\hspace{0.2cm}反向迭代器适配器的反向迭代}
	\addcontentsline{toc}{subsection}{4.7.\hspace{0.2cm}反向迭代器适配器的反向迭代}
	\subfile{content/chapter4/7.tex}
	
	\subsection*{\zihao{3} 4.8.\hspace{0.2cm}用哨兵迭代未知长度的对象}
	\addcontentsline{toc}{subsection}{4.8.\hspace{0.2cm}用哨兵迭代未知长度的对象}
	\subfile{content/chapter4/8.tex}
	
	\subsection*{\zihao{3} 4.9.\hspace{0.2cm}构建zip迭代器适配器}
	\addcontentsline{toc}{subsection}{4.9.\hspace{0.2cm}构建zip迭代器适配器}
	\subfile{content/chapter4/9.tex}
	
	\subsection*{\zihao{3} 4.10.\hspace{0.2cm}创建随机访问迭代器}
	\addcontentsline{toc}{subsection}{4.10.\hspace{0.2cm}创建随机访问迭代器}
	...
	\subsection*{\zihao{3} 5.1.\hspace{0.2cm}Lambda}
	\addcontentsline{toc}{subsection}{5.1.\hspace{0.2cm}Lambda}
	...
	\subsection*{\zihao{3} 5.3.\hspace{0.2cm}用于作用域可重用代码}
	\addcontentsline{toc}{subsection}{5.3.\hspace{0.2cm}用于作用域可重用代码}
	\subfile{content/chapter5/3.tex}
	
	\subsection*{\zihao{3} 5.4.\hspace{0.2cm}算法库中作为谓词}
	\addcontentsline{toc}{subsection}{5.4.\hspace{0.2cm}算法库中作为谓词}
	\subfile{content/chapter5/4.tex}
	
	\subsection*{\zihao{3} 5.5.\hspace{0.2cm}与std::function一起作为多态包装器}
	\addcontentsline{toc}{subsection}{5.5.\hspace{0.2cm}与std::function一起作为多态包装器}
	\subfile{content/chapter5/5.tex}
	
	\subsection*{\zihao{3} 5.6.\hspace{0.2cm}用递归连接lambda}
	\addcontentsline{toc}{subsection}{5.6.\hspace{0.2cm}用递归连接lambda}
	\subfile{content/chapter5/6.tex}
	
	\subsection*{\zihao{3} 5.7.\hspace{0.2cm}将谓词与逻辑连接词结合起来}
	\addcontentsline{toc}{subsection}{5.7.\hspace{0.2cm}将谓词与逻辑连接词结合起来}
	\subfile{content/chapter5/7.tex}
	
	\subsection*{\zihao{3} 5.8.\hspace{0.2cm}用相同的输入调用多个lambda}
	\addcontentsline{toc}{subsection}{5.8.\hspace{0.2cm}用相同的输入调用多个lambda}
	\subfile{content/chapter5/8.tex}
	
	\subsection*{\zihao{3} 5.9.\hspace{0.2cm}对跳转表使用映射lambda}
	\addcontentsline{toc}{subsection}{5.9.\hspace{0.2cm}对跳转表使用映射lambda}
	...
	\subsection*{\zihao{3} 6.2.\hspace{0.2cm}基于迭代器的复制}
	\addcontentsline{toc}{subsection}{6.2.\hspace{0.2cm}基于迭代器的复制}
	\subfile{content/chapter6/2.tex}
	
	\subsection*{\zihao{3} 6.3.\hspace{0.2cm}将容器元素连接到一个字符串中}
	\addcontentsline{toc}{subsection}{6.3.\hspace{0.2cm}将容器元素连接到一个字符串中}
	\subfile{content/chapter6/3.tex}
	
	\subsection*{\zihao{3} 6.4.\hspace{0.2cm}使用std::sort对容器进行排序}
	\addcontentsline{toc}{subsection}{6.4.\hspace{0.2cm}使用std::sort对容器进行排序}
	\subfile{content/chapter6/4.tex}
	
	\subsection*{\zihao{3} 6.5.\hspace{0.2cm}使用std::transform修改容器内容}
	\addcontentsline{toc}{subsection}{6.5.\hspace{0.2cm}使用std::transform修改容器内容}
	\subfile{content/chapter6/5.tex}
	
	\subsection*{\zihao{3} 6.6.\hspace{0.2cm}在容器中查找特定项}
	\addcontentsline{toc}{subsection}{6.6.\hspace{0.2cm}在容器中查找特定项}
	\subfile{content/chapter6/6.tex}
	
	\subsection*{\zihao{3} 6.7.\hspace{0.2cm}将容器的值限制在std::clamp的范围内}
	\addcontentsline{toc}{subsection}{6.7.\hspace{0.2cm}将容器的值限制在std::clamp的范围内}
	\subfile{content/chapter6/7.tex}
	
	\subsection*{\zihao{3} 6.8.\hspace{0.2cm}使用std::sample的样本数据集}
	\addcontentsline{toc}{subsection}{6.8.\hspace{0.2cm}使用std::sample的样本数据集}
	\subfile{content/chapter6/8.tex}
	
	\subsection*{\zihao{3} 6.9.\hspace{0.2cm}生成数据序列的排列}
	\addcontentsline{toc}{subsection}{6.9.\hspace{0.2cm}生成数据序列的排列}
	\subfile{content/chapter6/9.tex}
	
	\subsection*{\zihao{3} 6.10.\hspace{0.2cm}合并已排序的容器}
	\addcontentsline{toc}{subsection}{6.10.\hspace{0.2cm}合并已排序的容器}
	...
	\subsection*{\zihao{3} 7.1.\hspace{0.2cm}String格式化}
	\addcontentsline{toc}{subsection}{7.1.\hspace{0.2cm}String格式化}
	...
	\subsection*{\zihao{3} 7.3.\hspace{0.2cm}轻量级字符串对象——string\_view}
	\addcontentsline{toc}{subsection}{7.3.\hspace{0.2cm}轻量级字符串对象——string\_view}
	\subfile{content/chapter7/3.tex}
	
	\subsection*{\zihao{3} 7.4.\hspace{0.2cm}连接字符串}
	\addcontentsline{toc}{subsection}{7.4.\hspace{0.2cm}连接字符串}
	\subfile{content/chapter7/4.tex}
	
	\subsection*{\zihao{3} 7.5.\hspace{0.2cm}转换字符串}
	\addcontentsline{toc}{subsection}{7.5.\hspace{0.2cm}转换字符串}
	\subfile{content/chapter7/5.tex}
	
	\subsection*{\zihao{3} 7.6.\hspace{0.2cm}使用格式库格式化文本}
	\addcontentsline{toc}{subsection}{7.6.\hspace{0.2cm}使用格式库格式化文本}
	\subfile{content/chapter7/6.tex}
	
	\subsection*{\zihao{3} 7.7.\hspace{0.2cm}删除字符串中的空白}
	\addcontentsline{toc}{subsection}{7.7.\hspace{0.2cm}删除字符串中的空白}
	\subfile{content/chapter7/7.tex}
	
	\subsection*{\zihao{3} 7.8.\hspace{0.2cm}从用户输入中读取字符串}
	\addcontentsline{toc}{subsection}{7.8.\hspace{0.2cm}从用户输入中读取字符串}
	\subfile{content/chapter7/8.tex}
	
	\subsection*{\zihao{3} 7.9.\hspace{0.2cm}统计文件中的单词数}
	\addcontentsline{toc}{subsection}{7.9.\hspace{0.2cm}统计文件中的单词数}
	\subfile{content/chapter7/9.tex}
	
	\subsection*{\zihao{3} 7.10.\hspace{0.2cm}使用文件输入初始化复杂结构体}
	\addcontentsline{toc}{subsection}{7.10.\hspace{0.2cm}使用文件输入初始化复杂结构体}
	\subfile{content/chapter7/10.tex}
	
	\subsection*{\zihao{3} 7.11.\hspace{0.2cm}使用char\_traits定义一个字符串类}
	\addcontentsline{toc}{subsection}{7.11.\hspace{0.2cm}使用char\_traits定义一个字符串类}
	\subfile{content/chapter7/11.tex}
	
	\subsection*{\zihao{3} 7.12.\hspace{0.2cm}用正则表达式解析字符串}
	\addcontentsline{toc}{subsection}{7.12.\hspace{0.2cm}用正则表达式解析字符串}
	...
	\subsection*{\zihao{3} 8.2.\hspace{0.2cm}std::optional管理可选值}
	\addcontentsline{toc}{subsection}{8.2.\hspace{0.2cm}std::optional管理可选值}
	\subfile{content/chapter8/2.tex}
	
	\subsection*{\zihao{3} 8.3.\hspace{0.2cm}std::any保证类型安全}
	\addcontentsline{toc}{subsection}{8.3.\hspace{0.2cm}std::any保证类型安全}
	\subfile{content/chapter8/3.tex}
	
	\subsection*{\zihao{3} 8.4.\hspace{0.2cm}std::variant存储不同的类型}
	\addcontentsline{toc}{subsection}{8.4.\hspace{0.2cm}std::variant存储不同的类型}
	\subfile{content/chapter8/4.tex}
	
	\subsection*{\zihao{3} 8.5.\hspace{0.2cm}std::chrono的时间事件}
	\addcontentsline{toc}{subsection}{8.5.\hspace{0.2cm}std::chrono的时间事件}
	\subfile{content/chapter8/5.tex}
	
	\subsection*{\zihao{3} 8.6.\hspace{0.2cm}对可变元组使用折叠表达式}
	\addcontentsline{toc}{subsection}{8.6.\hspace{0.2cm}对可变元组使用折叠表达式}
	\subfile{content/chapter8/6.tex}
	
	\subsection*{\zihao{3} 8.7.\hspace{0.2cm}std::unique\_ptr管理已分配的内存}
	\addcontentsline{toc}{subsection}{8.7.\hspace{0.2cm}std::unique\_ptr管理已分配的内存}
	\subfile{content/chapter8/7.tex}
	
	\subsection*{\zihao{3} 8.8.\hspace{0.2cm}std::shared\_ptr的共享对象}
	\addcontentsline{toc}{subsection}{8.8.\hspace{0.2cm}std::shared\_ptr的共享对象}
	\subfile{content/chapter8/8.tex}
	
	\subsection*{\zihao{3} 8.9.\hspace{0.2cm}对共享对象使用弱指针}
	\addcontentsline{toc}{subsection}{8.9.\hspace{0.2cm}对共享对象使用弱指针}
	\subfile{content/chapter8/9.tex}
	
	\subsection*{\zihao{3} 8.10.\hspace{0.2cm}共享管理对象的成员}
	\addcontentsline{toc}{subsection}{8.10.\hspace{0.2cm}共享管理对象的成员}
	\subfile{content/chapter8/10.tex}
	
	\subsection*{\zihao{3} 8.11.\hspace{0.2cm}比较随机数引擎}
	\addcontentsline{toc}{subsection}{8.11.\hspace{0.2cm}比较随机数引擎}
	\subfile{content/chapter8/11.tex}
	
	\subsection*{\zihao{3} 8.12.\hspace{0.2cm}比较随机数分布发生器}
	\addcontentsline{toc}{subsection}{8.12.\hspace{0.2cm}比较随机数分布发生器}
	...
	\subsection*{\zihao{3} 9.2.\hspace{0.2cm}休眠一定的时间}
	\addcontentsline{toc}{subsection}{9.2.\hspace{0.2cm}休眠一定的时间}
	\subfile{content/chapter9/2.tex}
	
	\subsection*{\zihao{3} 9.3.\hspace{0.2cm}std::thread——实现并发}
	\addcontentsline{toc}{subsection}{9.3.\hspace{0.2cm}std::thread——实现并发}
	\subfile{content/chapter9/3.tex}
	
	\subsection*{\zihao{3} 9.4.\hspace{0.2cm}std::async——实现并发}
	\addcontentsline{toc}{subsection}{9.4.\hspace{0.2cm}std::async——实现并发}
	\subfile{content/chapter9/4.tex}
	
	\subsection*{\zihao{3} 9.5.\hspace{0.2cm}STL算法与执行策略}
	\addcontentsline{toc}{subsection}{9.5.\hspace{0.2cm}STL算法与执行策略}
	\subfile{content/chapter9/5.tex}
	
	\subsection*{\zihao{3} 9.6.\hspace{0.2cm}互斥锁和锁——安全地共享数据}
	\addcontentsline{toc}{subsection}{9.6.\hspace{0.2cm}互斥锁和锁——安全地共享数据}
	\subfile{content/chapter9/6.tex}
	
	\subsection*{\zihao{3} 9.7.\hspace{0.2cm}std::atomic——共享标志和值}
	\addcontentsline{toc}{subsection}{9.7.\hspace{0.2cm}std::atomic——共享标志和值}
	\subfile{content/chapter9/7.tex}
	
	\subsection*{\zihao{3} 9.8.\hspace{0.2cm}std::call\_once——初始化线程}
	\addcontentsline{toc}{subsection}{9.8.\hspace{0.2cm}std::call\_once——初始化线程}
	\subfile{content/chapter9/8.tex}
	
	\subsection*{\zihao{3} 9.9.\hspace{0.2cm}std::condition\_variable——解决生产者-消费者问题}
	\addcontentsline{toc}{subsection}{9.9.\hspace{0.2cm}std::condition\_variable——解决生产者-消费者问题}
	\subfile{content/chapter9/9.tex}
	
	\subsection*{\zihao{3} 9.10.\hspace{0.2cm}实现多个生产者和消费者}
	\addcontentsline{toc}{subsection}{9.10.\hspace{0.2cm}实现多个生产者和消费者}
	...
	\subsection*{\zihao{3} 10.2.\hspace{0.2cm}为路径类特化std::formatter}
	\addcontentsline{toc}{subsection}{10.2.\hspace{0.2cm}为路径类特化std::formatter}
	\subfile{content/chapter10/2.tex}
	
	\subsection*{\zihao{3} 10.3.\hspace{0.2cm}使用带有路径的操作函数}
	\addcontentsline{toc}{subsection}{10.3.\hspace{0.2cm}使用带有路径的操作函数}
	\subfile{content/chapter10/3.tex}
	
	\subsection*{\zihao{3} 10.4.\hspace{0.2cm}列出目录中的文件}
	\addcontentsline{toc}{subsection}{10.4.\hspace{0.2cm}列出目录中的文件}
	\subfile{content/chapter10/4.tex}
	
	\subsection*{\zihao{3} 10.5.\hspace{0.2cm}使用grep实用程序搜索目录和文件}
	\addcontentsline{toc}{subsection}{10.5.\hspace{0.2cm}使用grep实用程序搜索目录和文件}
	\subfile{content/chapter10/5.tex}
	
	\subsection*{\zihao{3} 10.6.\hspace{0.2cm}使用regex和directory\_iterator重命名文件}
	\addcontentsline{toc}{subsection}{10.6.\hspace{0.2cm}使用regex和directory\_iterator重命名文件}
	\subfile{content/chapter10/6.tex}
	
	\subsection*{\zihao{3} 10.7.\hspace{0.2cm}创建磁盘使用计数器}
	\addcontentsline{toc}{subsection}{10.7.\hspace{0.2cm}创建磁盘使用计数器}
	...
	\subsection*{\zihao{3} 11.2.\hspace{0.2cm}为搜索建议创建一个trie类}
	\addcontentsline{toc}{subsection}{11.2.\hspace{0.2cm}为搜索建议创建一个trie类}
	\subfile{content/chapter11/2.tex}
	
	\subsection*{\zihao{3} 11.3.\hspace{0.2cm}计算两个vector的误差和}
	\addcontentsline{toc}{subsection}{11.3.\hspace{0.2cm}计算两个vector的误差和}
	\subfile{content/chapter11/3.tex}
	
	\subsection*{\zihao{3} 11.4.\hspace{0.2cm}创建自己的算法:split}
	\addcontentsline{toc}{subsection}{11.4.\hspace{0.2cm}创建自己的算法:split}
	\subfile{content/chapter11/4.tex}
	
	\subsection*{\zihao{3} 11.5.\hspace{0.2cm}利用现有算法:gather}
	\addcontentsline{toc}{subsection}{11.5.\hspace{0.2cm}利用现有算法:gather}
	\subfile{content/chapter11/5.tex}
	
	\subsection*{\zihao{3} 11.6.\hspace{0.2cm}删除连续的空格}
	\addcontentsline{toc}{subsection}{11.6.\hspace{0.2cm}删除连续的空格}
	\subfile{content/chapter11/6.tex}
	
	\subsection*{\zihao{3} 11.7.\hspace{0.2cm}数字转换为单词}
	\addcontentsline{toc}{subsection}{11.7.\hspace{0.2cm}数字转换为单词}
